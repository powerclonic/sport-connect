<template>
  <main class="relative flex min-h-dvh w-full flex-col overflow-hidden">
    ...
    <div class="relative z-10 mx-auto flex min-h-dvh w-full max-w-7xl flex-col justify-between px-6 py-6">
      ...
      <section :aria-label="t('entry.title')" class="mx-auto mt-auto flex w-full max-w-md flex-col gap-8 pb-2 md:mx-0">
        ...
        <div class="flex flex-col gap-4">
          ...
          >
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <v-btn-primary to="/register">
                {{ t('entry.athletes.register') }}
                <v-icon end icon="mdi-arrow-right" />
              </v-btn-primary>

              <v-btn-secondary
                class="w-full sm:w-auto sm:flex-1 !min-w-0 !text-sm !font-semibold !tracking-wide !normal-case [font-family:var(--font-body)]"
                size="large"
                to="/login"
              >
